...
#define QUANT_TESTE 3
 ...
 //fun��o auxiliar para verificar se o arquivo existe e est� vazio.
...
void CargaInicial(){
    ...
    //cria apenas se os dados ou os �NDICES n�o existirem/estiverem vazios.
    if(VerificarSeDeveCriar("output/medicos.bin") || VerificarSeDeveCriar("output/indices_medicos.bin")){
        ...
        printf("Medicos de teste e �ndices criados.\n");
    ...
    if(VerificarSeDeveCriar("output/pacientes.bin") || VerificarSeDeveCriar("output/indices_pacientes.bin")){
        ...
        printf("Pacientes de teste e �ndices criados.\n");
